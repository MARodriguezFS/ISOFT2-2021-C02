...
import dominio.GestorJefeSala;
import dominio.GestorReservas;
import presentacion.IUConectar;
import presentacion.IUJefeDeSala;
import presentacion.IUCancelarReserva;
...
public class TestIT1 {
	...
	public TestIT1(int idMesa, int turno, String fecha, String nombreCliente) {
		this.idMesa = idMesa;
		this.turno = turno;
		this.fecha = fecha;
