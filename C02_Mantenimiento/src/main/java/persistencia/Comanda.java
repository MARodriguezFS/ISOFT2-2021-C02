...
/**
 * Esta clase seria la clase DAO y sirve como intermediario entre el agente y la clase GestorComanda
 * @author Alejandro Ruiz Aranda y Jesus Santiyan Reviriego
 * @version 0.1.0
 * @see "Comanda"
 * @since 0.1.0
 */
...
public class Comanda {
	 ...
	 * @return devuelve un int 0 o 1 segun se haga la operacion
	 * @throws devuelve el fallo correspondiente en caso de fallar la operacion
	 */
