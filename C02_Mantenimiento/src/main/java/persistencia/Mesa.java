...
/**
 * Esta clase seria la clase DAO y sirve como intermediario entre el agente y la clase GestorMesa
...
public class Mesa {
	 ...
	 * @throws en caso de surgir un problema devuelve el fallo generado.
	 */
	 ...
	 * @throws en caso de fallo devuelve el fallo obtenido.
	 */
	 ...
	 * @return devuelve un int 0 o 1 en segun realice la operacion.
	 * @throws en caso de fallo devuelve el fallo obtenido.
	 */
	 ...
	 * @param "estado" el parametro de este método es el estado a cambiar.
	 * @return devuelve un int 0 o 1 segun se realice la operacion.
	 * @throws en caso de fallo devuelve el fallo obtenido.
	 */
	 ...
	 * @param "id" el unico parametro de este metodo es el id del camarero.
	 * @return devuelve un int 0 o 1 segun se realice la operacion.
	 * @throws en caso de fallo devuelve el fallo obtenido.
	 */
