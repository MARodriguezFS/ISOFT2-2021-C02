...
public class GestorComandaCrearComandaIncorrectaTest {
	
	private long primero, segundo, postre, bebida, entrantes, idCamarero, idMesa;
	static GestorComanda gestor;
	...
	public GestorComandaCrearComandaIncorrectaTest(long primero, long segundo, long postre, long bebida, long entrantes, long idCamarero, long idMesa) {
	...
	public static void setUpBeforeClass() throws Exception {
		GestorComanda gestor = new GestorComanda();
	}
